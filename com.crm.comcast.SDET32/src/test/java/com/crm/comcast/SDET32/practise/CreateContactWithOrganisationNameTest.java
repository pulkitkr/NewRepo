...
public class CreateContactWithOrganisationNameTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String organisationName = workbook.getSheet("Sheet2").getRow(2).getCell(2).getStringCellValue()+value;
		String firstName = workbook.getSheet("Sheet2").getRow(2).getCell(3).getStringCellValue()+value;
		String lastName = workbook.getSheet("Sheet2").getRow(2).getCell(4).getStringCellValue()+value;
