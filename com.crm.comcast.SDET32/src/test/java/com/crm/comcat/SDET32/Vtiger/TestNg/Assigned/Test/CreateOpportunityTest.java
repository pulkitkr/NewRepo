...
/**
 *  This class is used to create opportunity by selecting created organization 
 * @author hp
 *
 */
...
public class CreateOpportunityTest extends BaseClass {
	/**
	 * This is a testscript to create opportunity using organization
	...
	public void createOpportunityUsingOrganisation() throws EncryptedDocumentException, IOException, InterruptedException {
		...
		//organization and opportunity object creation
		...
		createOpp.handleSalesStageDropdown("Closed Won");
