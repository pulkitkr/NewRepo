...
/**
 *  This class is used to create opportunity and select sales stage as close lost
 * @author hp
 *
 */
//@Listeners(com.crm.comcast.SDET32.genericUtility.ListenerImplementationClass.class)
public class CreateOpportunityUsingCloseLost extends BaseClass{


	/**
	 * This is a testscript to create opportunity using organization and select close lost
	 * @throws InterruptedException
	 * @throws EncryptedDocumentException
	 * @throws IOException
	 */
	@Test(groups = "regressionTesting")
	public void CreateOpportunityUsingOrganisationCloseLost() throws InterruptedException, EncryptedDocumentException, IOException {
